...
class ModelTraining:
    def __init__(self):
        ...
        logger.info("Model Training Initializing...")
    ...
    def train_model(self, X_train, y_train):
        try:
            ...
            logger.info("Model trained and save successfully!")
    ...
    def evaluate_model(self, X_test, y_test):
        try:
            ...
            precision = precision_score(y_test, y_pred, average='weighted') #for multilabel classification used weighted
            ...
            sns.heatmap(confusion, annot=True, cmap="Blues", xticklabels=np.unique(y_test), yticklabels=np.unique(y_test))
            ...
            logger.error(f"Error while performing model evaluation {e}")
            raise CustomException("Error while performing model evaluation ", e)
